...
/**
 * Material Symbols Outlined "settings" (齿轮), 24dp, opsz=24 wght=400 FILL=0 GRAD=0 ROND=50.
 * 来源: https://fonts.gstatic.com/render/v1/Material+Symbols+Outlined/24dp/settings.kt
 */
